...
require 'sample_data_dump/commands/download_compressed_sample_data_dumps'

module SampleDataDump
  module Commands
    describe DownloadCompressedSampleDataDumps do
      let(:command) do
      ...
      describe '#result' do
        ...
        before do
          ...
          expect(compressed_dump_storage_gateway)
            .to receive(:retrieve_compressed_dump_file)
