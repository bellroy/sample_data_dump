...
require 'sample_data_dump/use_cases/actor_uploads_sample_data_files'

module SampleDataDump
  module UseCases
    describe ActorUploadsSampleDataFiles do
      ...
      describe '#execute' do
        ...
        before do
          ...
          expect(persistence)
            .to receive(:move_compressed_dump_file_to_central_location)
            .with(table_configuration_one)
            .and_return(Dry::Monads::Success(true))
