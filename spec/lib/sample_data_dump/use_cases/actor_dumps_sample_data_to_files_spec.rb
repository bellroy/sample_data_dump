...
require 'sample_data_dump/use_cases/actor_dumps_sample_data_to_files'

module SampleDataDump
  module UseCases
    describe ActorDumpsSampleDataToFiles do
      ...
      describe '#result' do
        ...
        before do
          ...
          expect(persistence)
            .to receive(:dump_and_compress_data_to_local_file)
            .with(table_configuration_one)
            .and_return(Dry::Monads::Success(true))
